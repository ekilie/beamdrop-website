...
import {
  ...
  Server, FileText, Key, ChevronRight, ExternalLink
} from "lucide-react";
...
const features = [
  ...
  { icon: Shield, title: "Security", desc: "HTTPS/TLS, CORS, CSP headers, and password auth" },
  ...
  { icon: Terminal, title: "CLI First", desc: "Simple command-line flags for all configuration" },
  { icon: Zap, title: "Lightweight", desc: "Built with Go for minimal resource usage" },
];
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border bg-card/50 backdrop-blur-sm mb-8">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Open Source • Self-Hosted</span>
            </div>
          </motion.div>
